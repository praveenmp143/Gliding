...
var MemStorage = class {
  ...
  constructor() {
    ...
    this.waitlistSignups = /* @__PURE__ */ new Map();
  ...
  async createWaitlistSignup(insertSignup) {
  ...
  async getWaitlistSignupByEmail(email) {
...
var waitlistSignups = pgTable("waitlist_signups", {
  id: serial("id").primaryKey(),
...
var insertWaitlistSignupSchema = createInsertSchema(waitlistSignups).pick({
  firstName: true,
  lastName: true,
  email: true,
  referralSource: true
